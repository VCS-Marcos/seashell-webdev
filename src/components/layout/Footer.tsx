          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-ocean transition-colors"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-primary-foreground/70 hover:text-gold transition-colors text-sm inline-flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+248XXXXXXX" className="text-primary-foreground/70 hover:text-gold transition-colors text-sm">
                  +248 XXX XXXX
                </a>
              </li>
              <li className="flex items-center gap-3">
