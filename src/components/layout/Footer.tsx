          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+2484321080" className="text-primary-foreground/70 hover:text-gold transition-colors text-sm">+248 4321 080 | +248 4321 762 | +248 4324 361</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-ocean-light shrink-0" />
                <a href="mailto:info@seashelltravel.sc" className="text-primary-foreground/70 hover:text-gold transition-colors text-sm">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
            <p>
              © {new Date().getFullYear()} Seashell Travel (Pty) Ltd. All rights reserved. Site by{" "}
              <a href="https://www.switch.sc" target="_blank" rel="noopener noreferrer">
                SWITCH
              </a>
            </p>
